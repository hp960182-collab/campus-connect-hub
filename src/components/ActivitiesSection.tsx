...
const ActivitiesSection = () => {
  ...
  return (
    <section id="activities" className="section-padding bg-background" ref={ref}>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {activities.map((activity, index) => (
            <motion.div
              ...
              className="group p-6 lg:p-8 rounded-xl border border-border bg-card hover:border-gold/30 hover:shadow-lg transition-all duration-300"
            >
              {/* Icon */}
              <div className="w-14 h-14 rounded-xl bg-navy/5 group-hover:bg-gold/10 flex items-center justify-center mb-5 transition-colors duration-300">
                <activity.icon className="w-7 h-7 text-navy group-hover:text-gold transition-colors duration-300" />
              </div>
